...
CHARA_NAME = {
    ...
    1010: ["真步", "マホ", "Maho", "狐狸", "真扎", "针扎", "咕噜灵波", "真布", "🦊"],
    1011: ["璃乃", "リノ", "Rino", "妹弓"],
    ...
    1093: ["露", "ルゥ", "Ruu", "逃课女王"],
    1094: ["古蕾娅", "グレア", "Gurea", "龙姬", "古雷娅", "古蕾亚", "古雷亚", "🐲🐔", "🐉🐔", "古蕾雅", "古雷雅"],
    ...
    1128: ["真阳(游骑兵)", "マヒル(レンジャー)", "Mahiru(Ranger)", "骑兵奶牛", "游侠奶牛", "游骑兵奶牛", "护林员奶牛", "护林奶牛", "游侠🐄", "游侠🐮", "游侠真☀"],
    1129: ["璃乃(奇境)", "リノ(ワンダー)", "Rino(Wonder)", "璃乃(仙境)", "爽弓", "爱丽丝弓", "爱弓", "兔弓", "奇境妹弓", "仙境妹弓", "白丝妹弓", "爱丽丝妹弓", "1151弓","童弓","铜弓","童工"],
    1130: ["步未(奇境)", "アユミ(ワンダー)", "Ayumi(Wonder)", "步未(仙境)", "仙境步美", "路人兔", "路人🐰", "路人🐇", "仙境路人妹", "兔人妹", "爱丽丝路人", "奇境路人", "仙境路人"],
    1131: ["流夏(夏日)", "ルカ(サマー)", "Ruka(Summer)", "水卢卡", "泳装流夏", "水流夏", "泳装刘夏", "水刘夏", "泳装大姐", "泳装大姐头", "水大姐", "水大姐头", "水儿力", "泳装儿力", "水流"],
    ...
    1134: ["初音(夏日)", "ハツネ(サマー)", "Hatsune(Summer)", "水hego", "水星法", "海星", "水星星法", "泳装星法", "水⭐法", "水⭐", "水星", "水睡法", "湦"],
    1135: ["美里(夏日)", "ミサト(サマー)", "Misato(Summer)", "水母", "泳装圣母", "水圣母"],
    1136: ["纯(夏日)", "ジュン(サマー)", "Jun(Summer)", "水黑骑", "潶骑", "水saber", "💧黑骑"],
    ...
    1802: ["优衣(公主)", "ユイ(プリンセス)", "Yui(Princess)", "公主优衣", "公主yui", "公主由衣", "公主种田", "公主结衣", "公主田", "公主ue", "掉毛优衣", "掉毛yui", "掉毛ue", "掉毛", "飞翼优衣", "飞翼ue", "飞翼", "飞翼高达"],

    1804: ["贪吃佩可(公主)", "ペコリーヌ(プリンセス)", "Pekoriinu(Princess)", "命吃", "公主吃", "公主饭", "公主吃货", "公主佩可", "公主饭团", "公主🍙", "命运高达", "高达", "命运公主", "高达公主", "春哥高达", "🤖🍙", "🤖"],
    1805: ["可可萝(公主)", "コッコロ(プリンセス)", "Kokkoro(Princess)", "公主可", "公主妈", "公主可可罗", "公主可萝", "公主可可萝", "命运可可罗", "命运妈", "月光蝶妈", "月光妈", "命妈", "高达妈", "高达可可罗", "高达可可萝", "命运可可萝", "蝶妈", "蝴蝶妈", "月光可", "月光可萝", "月光可可萝", "蝶可", "蝶可萝", "蝶可可萝"],
