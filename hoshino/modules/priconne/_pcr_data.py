...
CHARA_NAME = {
    ...
    1131: ["流夏(夏日)", "ルカ(サマー)", "Ruka(Summer)", "水刘夏", "水流夏", "水卢卡", "水大姐", "水大姐头"],
    1132: ["杏奈(夏日)", "アンナ(サマー)", "Anna(Summer)", "水中二", "冲二"],
    1133: ["七七香(夏日)", "ナナカ(サマー)", "Nanaka(Summer)", "水娜娜卡", "水77k", "水77香"],
    1134: ["初音(夏日)", "ハツネ(サマー)", "Hatsune(Summer)", "水hego", "水星法", "水星星法", "水⭐法", "水⭐", "水星", "水睡法"],
    1135: ["美里(夏日)", "ミサト(サマー)", "Misato(Summer)", "水圣母"],
    ...
    1802: ["优衣(公主)", "ユイ(プリンセス)", "Yui(Princess)", "公主种田", "公主优衣", "公主由衣", "公主结衣", "公主ue", "u0", "掉毛", "掉毛优衣"],
